<x-app-layout>
                    ...
                    <form method="POST" action="{{ route('schedules.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" 
                                ...
                                rows="3"
                                class="block w-full mt-2 px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
                                placeholder="Enter schedule description (optional)">{{ old('description') }}</textarea>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    <input id="kingschat_notification" 
                                        ...
                                        value="1"
                                        {{ old('kingschat_notification') ? 'checked' : '' }}
                        ...
                        <div id="recurrence_pattern_div" class="hidden">
    ...
    <script>
        ...
        // Show recurrence pattern if it was previously selected (for validation errors)
        if (document.getElementById('is_recurring').checked) {
            document.getElementById('recurrence_pattern_div').classList.remove('hidden');
        }
    </script>
</x-app-layout>
